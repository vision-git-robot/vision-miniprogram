...
/**
 * 全局只执行一次的方法
 * 如果在App()中调用，需要先sessionStorage.setApp(this);
 * 为了防止独立分包和主包的方法重复执行......
 */
    ...
    return _runtimeModule2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            loginCgi = opt.loginCgi, appid = opt.appid, buzid = opt.buzid, scene = opt.scene, _opt$loadingText = opt.loadingText, loadingText = _opt$loadingText === undefined ? '登录中' : _opt$loadingText, needUserInfo = opt.needUserInfo;
...
var sendLoginRequest = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_runtimeModule2.default.mark(function _callee2(_ref3) {
    var _ref3$loginCgi = _ref3.loginCgi,
        ...
        loadingText = _ref3$loadingText === undefined ? '登录中' : _ref3$loadingText,
