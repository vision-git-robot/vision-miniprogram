...
/* harmony import */ var _actionHandler_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(72);
...
/* harmony import */ var _utils_eventProxy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43);
/* harmony import */ var _actionParams__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
...
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(20);
...
var pageEventListener = __webpack_require__(153);

// EXTERNAL MODULE: ./handlers/shared/eventListener/componentEventListener.js
var componentEventListener = __webpack_require__(154);

// EXTERNAL MODULE: ./handlers/shared/eventListener/hotAreaEventListener.js
var hotAreaEventListener = __webpack_require__(214);
...
var hotAreaNodeMap = __webpack_require__(83);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _handlers_reactHandlers_render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(212);
/* harmony import */ var _handlers_shared_injectStyle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(151);
/* harmony import */ var _handlers_shared_instanceMap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(108);
/* harmony import */ var _handlers_shared_selectVersion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(211);
/* harmony import */ var _libraries_base_components_Button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(216);
...
if (process.env.SSR) {
  ...
  ReactDOMServer = __webpack_require__(401);
} // Global Style
...
const meta = {
  "title": "小程序",
  "desc": "ceshi mini",
  "start": new Date('Tue Dec 29 2020 21:52:19 GMT+0800 (GMT+08:00)'),
  "end": new Date('Tue Jan 26 2021 21:52:19 GMT+0800 (GMT+08:00)'),
  "actId": 3,
  "actKey": "miniprogram",
...
if (typeof window !== 'undefined') {
  if (!window['JIMU_VARS']) {
    Object.defineProperty(window, 'JIMU_VARS', {
      value: {
        "key": "miniprogram",
        "actStartTime": "2020-12-29T13:52:19.000Z",
        "actEndTime": "2021-01-26T13:52:19.000Z",
        "isJimu": false,
        "mainColor": "rgb(255,83,25)",
        "subColor": "#FF860C"
      },
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(158)))
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _actionHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(218);
/* harmony import */ var _adaptor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(217);
/* harmony import */ var _shared_componentEventActionEmitter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(110);
/* harmony import */ var _shared_customEventTrigger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(109);
/* harmony import */ var _shared_eventListener__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(153);
/* harmony import */ var _shared_eventListener__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(44);
/* harmony import */ var _PositionHandler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(155);
/* harmony import */ var _shared_actionParams__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(19);
...
// EXTERNAL MODULE: F:/Tencent/vision/external/workspace/libraries/materials-fudao/node_modules/antd-mobile/lib/button/index.js
var lib_button = __webpack_require__(207);
var button_default = /*#__PURE__*/__webpack_require__.n(lib_button);

// EXTERNAL MODULE: F:/Tencent/vision/external/workspace/libraries/materials-fudao/node_modules/strict-uri-encode/index.js
var strict_uri_encode = __webpack_require__(208);
var strict_uri_encode_default = /*#__PURE__*/__webpack_require__.n(strict_uri_encode);

// EXTERNAL MODULE: F:/Tencent/vision/external/workspace/libraries/materials-fudao/node_modules/decode-uri-component/index.js
var decode_uri_component = __webpack_require__(209);
var decode_uri_component_default = /*#__PURE__*/__webpack_require__.n(decode_uri_component);

// EXTERNAL MODULE: F:/Tencent/vision/external/workspace/libraries/materials-fudao/node_modules/split-on-first/index.js
var split_on_first = __webpack_require__(210);
...
// EXTERNAL MODULE: F:/Tencent/vision/external/workspace/libraries/materials-fudao/node_modules/antd-mobile/lib/button/style/css.js
var css = __webpack_require__(445);

// EXTERNAL MODULE: ./libraries/base/components/Button/view/index.scss
var view = __webpack_require__(452);
...
// EXTERNAL MODULE: F:/Tencent/vision/external/workspace/libraries/materials-fudao/node_modules/@sentry/browser/esm/sdk.js + 34 modules
var sdk = __webpack_require__(464);
...
var componentEventActionEmitter = __webpack_require__(110);

// EXTERNAL MODULE: ./handlers/shared/componentNodeMap.js
var componentNodeMap = __webpack_require__(17);

// EXTERNAL MODULE: ./handlers/shared/customEventTrigger.js
var customEventTrigger = __webpack_require__(109);
...
var actionParams = __webpack_require__(19);
...
// EXTERNAL MODULE: F:/Tencent/vision/external/workspace/libraries/materials-fudao/node_modules/lodash.template/index.js
var lodash_template = __webpack_require__(215);
...
/* harmony import */ var ramda__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(458);
...
/* harmony import */ var _shared_eventListener__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(154);
/* harmony import */ var _shared_utils_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(20);
/* harmony import */ var _shared_utils_events__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(22);
/* harmony import */ var _shared_actionHandler_types__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7);
/* harmony import */ var _shared_actionHandler_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(72);
/* harmony import */ var _shared_actionParams__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(19);
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
// EXTERNAL MODULE: F:/Tencent/vision/external/workspace/libraries/materials-fudao/node_modules/react-dom/index.js
var react_dom = __webpack_require__(204);
var react_dom_default = /*#__PURE__*/__webpack_require__.n(react_dom);

// EXTERNAL MODULE: F:/Tencent/vision/external/workspace/libraries/materials-fudao/node_modules/@tencent/imwxutils/miniprogram_dist/index.js
var miniprogram_dist = __webpack_require__(58);

// EXTERNAL MODULE: ./src/app.jsx
var app = __webpack_require__(205);

// EXTERNAL MODULE: ./assets/style/reset.css
var style_reset = __webpack_require__(227);

// EXTERNAL MODULE: ./assets/style/vision.css
var vision = __webpack_require__(228);

// CONCATENATED MODULE: ./mp_utils/utils.js

const isLogin = () => {
  const uidType = parseInt(Object(miniprogram_dist["getCookie"])('uid_type'), 10);
  return uidType === 1002 || uidType === 20000;
};
// CONCATENATED MODULE: ./mp_utils/hooks.js



const wxLogin = Object(miniprogram_dist["promisify"])(wx.login);
const useWxLoginData = () => {
  const [loginData, setLoginData] = Object(react["useState"])(null);
  Object(react["useEffect"])(() => {
    console.log('useWxLoginData effect fired');

    const getWxLoginData = async () => {
      ...
      try {
        ...
        if (!code) {
          console.error(`wx.login 失败！${errMsg}`);
          return;
        }
        ...
        console.error('Call wx api failed', err);
      }

      if (!data) return;
      console.log('get new wxcode');
      setLoginData(data);
    };

    window.addEventListener('wxshow', getWxLoginData);
    return () => window.removeEventListener('wxshow', getWxLoginData);
  }, []);
  const clearLoginData = Object(react["useCallback"])(() => setLoginData(null), [setLoginData]);
  return {
    wxLoginData: loginData,
    clearLoginData
  };
};
const useWxPageParams = () => {
  const [params, setParams] = Object(react["useState"])({});
  Object(react["useEffect"])(() => {
    const getPageParams = pageParams => {
      console.log('wx page load with params:', pageParams);
      setParams(pageParams);
    };

    window.addEventListener('wxload', getPageParams);
    return () => window.removeEventListener('wxload', getPageParams);
  }, []);
  return params;
};
// CONCATENATED MODULE: ./index.mp.jsx
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WxDataContext", function() { return WxDataContext; });
...
function init() {
  if (!window.__tdw_report_inited) {
    // 罗盘
    miniprogram_dist["tdw"].configPage({
      page: `[vision]${window.VISION.meta.actKey}`
    });
    window.__tdw_report_inited = true;
  } // badjs 上报


  if (!window.__badjs_report_inited) {
    miniprogram_dist["badjs"].init({
      id: 1412
    });
    window.__badjs_report_inited = true;
  }
}

window.addEventListener('load', init);
const WxDataContext = Object(react["createContext"])({});
window.VISION.global.WxDataContext = WxDataContext;

const AppWithWxData = () => {
  const pageParams = useWxPageParams();
  const {
    wxLoginData,
    clearLoginData
  } = useWxLoginData();
  return react_default.a.createElement(WxDataContext.Provider, {
    value: {
      pageParams,
      loginData: wxLoginData,
      clearLoginData
    }
  }, react_default.a.createElement(app["a" /* default */], null));
};
...
function createApp() {
  ...
  react_dom_default.a.render(react_default.a.createElement(AppWithWxData, null), container);
} // 你也可以在此文件中进行一些初始化操作：
// 如引入公共样式、初始化上报等。
...
/* harmony import */ var promise_timeout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(213);
...
/* harmony import */ var _instanceMap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(108);
/* harmony import */ var _actionParams__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(19);
